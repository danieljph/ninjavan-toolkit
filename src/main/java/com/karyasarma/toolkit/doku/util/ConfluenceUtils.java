...
public class ConfluenceUtils
{
    ...
    {
        return toCodeBlock(CODE_BLOCK_PLAINTEXT_TEMPLATE, "");
    }

    public static ClipboardData blankCodeBlockSql()
    {
        return toCodeBlock(CODE_BLOCK_SQL_TEMPLATE, "");
    }
    ...
    {
        return new ClipboardData("", BLANK_EXPAND_TEMPLATE);
    }

    public static ClipboardData blankExpandPlusCodeBlock()
    {
        return new ClipboardData("", BLANK_EXPAND_PLUS_CODE_BLOCK_TEMPLATE);
    }
}
